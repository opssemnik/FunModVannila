...
public class ModelGanondorf extends ModelBase
{
    ...
    public ModelGanondorf(float par1)
    {
        this(par1, 0.0F);
    }

    public ModelGanondorf(float par1, float par2)
    {
        this.heldItemLeft = 0;
    ...
    public void setLivingAnimations(EntityLiving par1EntityLiving, float f1, float f2, float f3)
    {
        ...
        bipedLeftLeg.rotateAngleX = MathHelper.cos(f1 * 0.6662F) * 1.4F * f2;
        bipedRightLeg.rotateAngleX = MathHelper.cos(f1 * 0.6662F + (float)Math.PI) * 1.4F * f2;
    } 
