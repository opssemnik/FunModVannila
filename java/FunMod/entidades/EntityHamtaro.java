 ...
 //   }
   ...
   // }
    ...
    public void onUpdate()
    {
        ...
        else if ((this.isShaking || this.field_70928_h) && this.field_70928_h)
        {
            ...
            {
                this.worldObj.playSoundAtEntity(this, "mob.villager", this.getSoundVolume(), (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
            }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (var2 != null && var2.getItem() == StaticHelper.FMItemLoader.Starman && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --var2.stackSize;
  ...
  //      return (par1ItemStack == null ? false : (!(par1ItemStack.getItem() instanceof ItemFood) ? false : ((ItemFood)par1ItemStack.getItem().fu)));
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityHamtaro))
        {
            return false;
        }
        else
        {
            EntityHamtaro var2 = (EntityHamtaro)par1EntityAnimal;
