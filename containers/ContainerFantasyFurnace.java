...
public class ContainerFantasyFurnace extends Container
{
    ...
    public ContainerFantasyFurnace(InventoryPlayer par1InventoryPlayer, EntidadeFantasyFurnace par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotFantasyFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (EntidadeFantasyFurnace.isItemFuel(var5))
                {
