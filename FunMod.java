...
public class FunMod {
	...
	public static HashMap<?, ?> playerStats = new HashMap<Object, Object>();
	...
	public void load(FMLInitializationEvent event) {
		...
		UpMushroom = new ItemUpCog(500, 4, false).setPotionEffect(
				Potion.heal.id, 30, 0, 1.0F).setUnlocalizedName("Up Mushroom");
		SuperMushroom = new ItemSuperCog(501, 4, false).setPotionEffect(
				Potion.resistance.id, 30, 0, 1.0F).setUnlocalizedName(
				"Super Mushroom");
		FireFlower = (new ItemFun(5000, 5, 1).setUnlocalizedName("Fire Flower")
				.setMaxDamage(20));
		Starman = (new ItemFun(5001, 8, 1).setUnlocalizedName("Starman"));
		LinkSword = (new LinkSword(5002, Link))
				.setCreativeTab(FunMod.funmodtab).setUnlocalizedName(
						"Link Sword");
		ThunderSword = (new ThunderSword(5003, Link)).setCreativeTab(
				FunMod.funmodtab).setUnlocalizedName("Thunder Sword");
		ThunderBlade = (new ThunderBlade(5015)
				.setUnlocalizedName("Thunder Blade"));
		MarioCoin = (new ItemFun(5004, 6, 16).setUnlocalizedName("Mario Coin"));
		MegaManHelmet = (new MegaManHelm(5007, MegaMan, 3, 0))
				.setUnlocalizedName("MegaMan Helmet");
		MegaManChest = (new MegaManChest(5008, MegaMan, 3, 1))
				.setUnlocalizedName("MegaMan Chest");
		MegaManPants = (new MegaManLeg(5009, MegaMan, 3, 2))
				.setUnlocalizedName("MegaMan Pants");
		MegaManBoots = (new MegaManBot(5010, MegaMan, 3, 3))
				.setUnlocalizedName("MegaMan Boots");
		SonicBoots = (new SonicBoots(5011, Sonic, 3, 3))
				.setUnlocalizedName("Sonic Boots");
		LinkBow = (new ItemLinkBow(5012).setUnlocalizedName("Link Bow")
				.setCreativeTab(FunMod.funmodtab)
				.setUnlocalizedName("Link Bow"));
		PearlOfLink = (new ItemFun(5016, 10, 64)
				.setUnlocalizedName("Pearl Of Link"));
		Battery = (new ItemFun(5017, 7, 64).setUnlocalizedName("Battery"));
		ThunderDust = (new ItemThunderDust(5018)
				.setUnlocalizedName("Thunder Dust"));
		ObsidianStick = (new ItemFun(5019, 19, 64)
				.setUnlocalizedName("Obsidian Stick"));
		Blade = (new ItemFun(5020, 20, 64).setUnlocalizedName("Blade"));
		QuestionBlock = new BlockQuestionBlock(225, 0).setHardness(2F)
				.setResistance(200F).setCreativeTab(FunMod.funmodtab)
				.setBlockName("Question Block");
		BrickBlock = new BlockBrickBlock(226, 0, 0).setHardness(3F)
				.setResistance(200F)
				./* setLightValue(0.2F). */setCreativeTab(FunMod.funmodtab)
				.setBlockName("Brick Block");
		tv = new BlockTv(200, 0).setResistance(.5F).setBlockName("Test")
				.setHardness(0.5f);
		sofa = new BlockSofa(255, 0, EntidadeN64.class).setResistance(.5F)
				.setBlockName("Sofa").setHardness(0.5f);
		FantasyGrass = (new FantasyGrass(210, 0)
				.setStepSound(Block.soundTypeGrass).setHardness(0.5F)
				.setResistance(1F).setBlockName("FantasyGrass"));
		FantasyStone = (new FantasyStone(211, 0).setHardness((float) 5.0)
				.setStepSound(Block.soundTypeStone).setResistance(1.0F)
				.setBlockName("FantasyStone"));
		FantasyDirt = (new FantasyDirt(212, 0).setHardness(0.5F)
				.setStepSound(Block.soundTypeGrass).setResistance(0.5F)
				.setBlockName("FantasyDirt"));
		FantasyLeaf = (new FantasyLeaf(218, 0)).setHardness(1.0F)
				.setStepSound(Block.soundTypeGrass).setResistance(1.0F)
				.setBlockName("FantasyLeaf");
		FantasyLog = (new FantasyLog(217).setResistance(1.0F).setHardness(1.0F)
				.setBlockName("forbiddenLog").setStepSound(Block.soundTypeWood));
		FantasyBiome = (new BiomeGenFantasy(65));
		FantasyPortal = (new BlockFantasyPortal(216, 0)
				.setStepSound(Block.soundTypeWood).setHardness(0.5F)
				.setResistance(1F).setBlockName("FantasyPortal"));
		MysticalStone = (new MysticalStone(215, 0, 0).setHardness(5.0F)
				.setStepSound(Block.soundTypeStone).setResistance(1000000.0F)
				.setBlockName("MysticalStone"));
		...
		plank = new BlockPlank(2222, 0).setHardness(2F).setResistance(200F)
				.setCreativeTab(FunMod.funmodtab).setBlockName("Plank");
		cobble = new BlocCobble(2223, 0).setHardness(2F).setResistance(200F)
				.setCreativeTab(FunMod.funmodtab).setBlockName("Cobble");
		// Item em 3d
		controle = (new ItemFun(3025, 35, 1).setUnlocalizedName("Controle")
				.setCreativeTab(FunMod.funmodtab).setFull3D());
		desativada = new FantasyFurnace(2831, false)
				.setBlockName("FantasyFurnace").setHardness(6F)
				.setStepSound(Block.soundTypeMetal)
				.setCreativeTab(FunMod.funmodtab);
		ativa = new FantasyFurnace(2832, true)
				.setBlockName("BrickFurnaceActive").setHardness(6F)
				.setStepSound(Block.soundTypeMetal);
		coal = (new ItemFun(3024, 46, 64).setUnlocalizedName("CoaL")
				.setCreativeTab(FunMod.funmodtab));
		...
		GameRegistry.addRecipe(
				new ItemStack(controle, 1),
				(new Object[] { " XY", "XZX", "HX ", Character.valueOf('X'),
		...
		GameRegistry.addRecipe(new ItemStack(sofa, 1), (new Object[] { " X ",
				"XXX", "XXX", Character.valueOf('X'), Blocks.wool }));
		GameRegistry.addRecipe(new ItemStack(desativada, 1), (new Object[] {
				"XXX", "X X", "XXX", Character.valueOf('X'), FantasyStone }));
		...
		EntityRegistry.registerModEntity(EntityThrowing.class, "Throwing", 126,
				this, 64, 1, true);
		EntityRegistry.registerGlobalEntityID(EntityLink.class, "Link", 100,
				8510747, 2551400);
		EntityRegistry.addSpawn(EntityLink.class, 100, 2, 3,
				EnumCreatureType.creature, new BiomeGenBase[] {
						FunMod.FantasyBiome, FunMod.FantasyBiome,
						FunMod.FantasyBiome });

		EntityRegistry.registerGlobalEntityID(EntityNess.class, "Ness", 101,
				25500, 30144255);
		EntityRegistry.addSpawn(EntityNess.class, 101, 1, 4,
		...
		FMLCommonHandler
				...
				.bus()
				.register(
						new FunModClientTickHandler(Type.WORLD, Side.CLIENT,
								Phase.START));
		...
		System.out
				.println("[FunMod] Finished FunMod Init Phase Without Any Errors");
		new ThreadGetData();
